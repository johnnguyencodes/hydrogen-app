                  ...
                  {journal.map((entry) => (
                    ...
                    >
                      <div className="flex flex-col md:flex-row md:items-start gap-4">
                        ...
                        <div className="journal-image-container flex-shrink-0 max-w-full md:max-w-md">
                          <div className="flex gap-3 overflow-x-auto pb-2 scrollbar-hide">
                            {parsedImageData.map((image, idx) =>
                              image.meta.date === entry.date &&
                              image.meta.date !== latestCarouselDateString ? (
                                <div
                                  className="relative rounded-md overflow-hidden border border-[var(--color-dark2)] shadow-sm flex-shrink-0 w-48 h-48"
